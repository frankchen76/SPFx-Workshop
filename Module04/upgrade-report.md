# Upgrade project Module04 to v1.15.0
...
```json
{
  "solution": {
    "metadata": {
      "shortDescription": {
        "default": "module-04-demo-1 description"
      },
      "longDescription": {
        "default": "module-04-demo-1 description"
      },
...
```json
{
  "solution": {
    "features": [
      {
        "title": "module-04-demo-1 Feature",
        "description": "The feature that activates elements of the module-04-demo-1 solution.",
        "id": "15a9b0e1-85e4-4d5c-9562-8b23e9f7c60a",
        "version": "1.0.0.0"
      }
    ]
  }
...
npm i -DE @microsoft/sp-build-web@1.15.0 @microsoft/sp-module-interfaces@1.15.0 ajv@6.12.5 @types/webpack-env@1.15.2 @microsoft/rush-stack-compiler-4.5@0.2.2 @rushstack/eslint-config@2.5.1 @microsoft/eslint-plugin-spfx@1.15.0 @microsoft/eslint-config-spfx@1.15.0 eslint@8.7.0 eslint-plugin-react-hooks@4.3.0 @types/react@16.9.51 gulp@4.0.2 @types/es6-promise@0.0.33
npm dedupe
rm "tslint.json"
cat > ".eslintrc.js" << EOF 
require('@rushstack/eslint-config/patch/modern-module-resolution');
